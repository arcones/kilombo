...
class NCBIExtractorTest(TestCase):
    def test_extract_gses_from_summaries_short_study_summaries(self):
    ...
    def test_extract_srps_from_summaries_short_study_summaries(self):
        with open("./fixtures/6_study_summaries.json") as file:
            study_summaries = json.load(file)
        srps = []
        study_hierarchy = StudyHierarchy(study_summaries)
